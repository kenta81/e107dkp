...
if ($database) 
{
	...
	<table>
	<tr><td><label for=\"name\">".LAN_ADMIN_DATABASES_EDIT_LABELNAME."</label></td><td><input type=\"text\" name=\"name\" value=\"".$database->name."\"/></td></tr>
	<tr colspan=\"2\"><td style=\"text-align: right;\"><input type=\"submit\" value=\"".LAN_ADMIN_DATABASES_EDIT_SUBMIT."\"/></td></tr>
	</table>
	<input type=\"hidden\" value=\"".$database->id."\" name=\"id\"/>
	</form>";
}
else
{
	$text .= "<p>".LAN_ADMIN_DATABASES_EDIT_DATABASEDOESNOTEXIST."</p><p><a href=\"".e_SELF."\">Back</a></p>";
}
